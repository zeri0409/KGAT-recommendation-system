  ...
  <div id="details">
    ...
    <div class="main">
      ...
      <div class="block">
        <el-carousel height="560px" v-if="productPicture.length>1">
          <el-carousel-item v-for="item in productPicture" :key="item.id">
            <img style="height:560px;" :src="getImageUrl(item.product_picture || item.productPicture, productID)" :alt="item.intro" />
          </el-carousel-item>
        </el-carousel>
        <div v-if="productPicture.length==1">
          <img
            style="height:560px;"
            :src="getImageUrl(productPicture[0].product_picture || productPicture[0].productPicture, productID)"
        ...
        <div v-if="productPicture.length==0">
          <img
            style="height:560px;"
            :src="getLocalBookImage(productID)"
            alt="商品图片"
          />
        </div>
      </div>
      ...
      <div class="content">
        ...
        <p class="intro">{{productDetails.product_intro || productDetails.product_title}}</p>
